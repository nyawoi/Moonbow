...
{
    internal static class SaveDisconnectingPlayerPatch
    {
        private const string HarmonyPatchId = "net.aethar.Moonbow.Patches.SaveDisconnectingPlayerPatch";
        ...
        private static void Postfix(Entity entity)
        {
            ...
            foreach (var hook in ConnectionHooks)
            {
                try
                {
                    hook.OnPlayerDisconnect(entity);
                }
                catch (Exception e)
                {
        ...
        public static void Initialize()
        {
            ...
            var methodBase = AccessTools.Method(typeof(PlayerPersistence), nameof(PlayerPersistence.SaveDisconnectingPlayer));
            var methodPostfix = AccessTools.Method(typeof(SaveDisconnectingPlayerPatch), nameof(Postfix));
